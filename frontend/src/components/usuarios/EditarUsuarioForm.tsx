...
import { useEditUserForm } from "@/hooks/Usuarios/useEditUserForm"
import { 
  User, 
  Mail, 
  ArrowLeft,
...
export const EditarUsuarioForm: React.FC = () => {
      ...
      <div className="bg-white rounded-xl shadow-lg p-6">
        <div className="flex items-center justify-center py-12">
          <div className="text-center">
            ...
            <p className="text-gray-400 text-sm mt-1">Obteniendo información del usuario</p>
          </div>
        </div>
      </div>
    )
    ...
    <div className="bg-white rounded-xl shadow-lg p-6">
      <div className="overflow-x-auto rounded-lg border border-gray-200">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-500 text-sm mt-1">
                Modifica los campos del usuario {user.nombre && `${user.nombre}`}
              </p>
            </div>
        ...
        <form onSubmit={handleSubmit} className="p-6">
          {errors.general && user.id && (
            <div className="mb-6 bg-red-50 border border-red-200 rounded-lg p-4">
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-red-500" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                </svg>
                <p className="text-sm text-red-700 font-medium">Error al actualizar usuario</p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="col-span-full">
              <FormInput
                ...
                helperText="Debe ser una dirección de email válida"
              />
            </div>
          </div>
